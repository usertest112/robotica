...
int colorSensorIzquierdo(tSensors sIzquierdo){
	...
	if(colorIzquierdo > 40){ //SE TOMA COMO VALOR DE REFERENCIA EN BLANCO COMO VALOR SUPERIOR AL 30
		colorBlanco = 1;//SE RETORNA 1 -> COLOR BLANCO;
		}else if(colorIzquierdo >= 30 && colorIzquierdo <= 36){
		colorBlanco = 2;//SE RETORNA 2 -> COLOR POSIBLE VERDE;
		}else if(colorIzquierdo >= 5 && colorIzquierdo <= 30){
...
int colorSensorDerecho(tSensors sDerecho){
	...
	if(colorDerecho > 40){//SE TOMA COMO VALOR DE REFERENCIA EN BLANCO COMO VALOR SUPERIOR AL 30
		colorBlanco = 1;//SE RETORNA 1 -> COLOR BLANCO;
		}else if(colorDerecho >= 30 && colorDerecho <= 36){
		colorBlanco = 2;//SE RETORNA 2 -> COLOR POSIBLE VERDE
		}else if(colorDerecho >= 5 && colorDerecho <= 30){
		colorBlanco = 0;//SE RETORNA 0 -> COLOR NEGRO;
	}
	return colorBlanco;
}
...
int colorRGBSensorIzquierdo(tSensors sIzquierdo){
	...
	*/
	if((redChannel >= 3 && redChannel <= 30) && (greenChannel >= 10 && greenChannel <= 35) && (blueChannel >= 4 && blueChannel <= 20)){
...
int colorRGBSensorDerecho(tSensors sDerecho){
	...
	*/
	if((redChannel >= 3 && redChannel <= 30) && (greenChannel >= 11 && greenChannel <= 41) && (blueChannel >= 6 && blueChannel <= 23)){
		colorSensor = 3;//COLOR VERDE
	}

...
task main()
{
	...
	while(true){
		...
		displayCenteredBigTextLine ( 1 ,  "SenIzq %d", SensorRaw[S1] );
		displayCenteredBigTextLine ( 3 ,  "SenDer %d", SensorRaw[S2] );
		displayCenteredBigTextLine ( 5 ,  "SenCen %d", SensorRaw[S3] );
